...
interface AdministradorLoginPageProps {
  onBack: () => void;
  onRegister: () => void;
  onLoginSuccess: () => void;
}

const AdministradorLoginPage: React.FC<AdministradorLoginPageProps> = ({ onBack, onRegister, onLoginSuccess }) => {
...
export default AdministradorLoginPage;
